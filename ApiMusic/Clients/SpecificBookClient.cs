...
{
    public class SpecificBookClient
    {
		public async Task<List<SpecificBookModel>> GetSpecificBook()
		{
			...
			var request = new HttpRequestMessage
			{
				...
				RequestUri = new Uri("https://game-of-thrones-audio-book.p.rapidapi.com/books/a-game-of-thrones"),
				Headers =
				{
			...
			var response = await client.SendAsync(request);
			{
				...
				var res = JsonConvert.DeserializeObject<List<SpecificBookModel>>(body);
